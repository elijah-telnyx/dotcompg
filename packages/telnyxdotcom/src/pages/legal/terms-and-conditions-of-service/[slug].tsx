import { getLegalTermsAndConditionsOfServicePage, getLegalTermsAndConditionsOfServicePages } from 'lib/Contentful';
...
type LegalTermsAndConditionsPageProps = Awaited<ReturnType<typeof getLegalTermsAndConditionsOfServicePage>> & {
  preview: boolean;
};
...
const TermsAndConditionsOfServices = ({ hero, sections, preview }: LegalTermsAndConditionsPageProps) => {
  return (
    <>
...
export const getStaticPaths = async () => {
  const entries = await getLegalTermsAndConditionsOfServicePages();
  if (entries) {
    return {
...
export const getStaticProps = defaultGetStaticProps<LegalPage>({
  page: 'legal/terms-and-conditions-of-service/[slug]',
  getData: ({ params, preview }) =>
    getLegalTermsAndConditionsOfServicePage({ slug: params?.slug as string }, { preview }),
});

export default TermsAndConditionsOfServices;
