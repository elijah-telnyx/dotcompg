...
type PricingMessagingApiProps = Awaited<ReturnType<typeof getData>> & {
  preview: boolean;
};
...
export const getStaticProps = defaultGetStaticProps<PricingMessagingApiProps>({
