...
const pageName = 'video-api';
const getData = fetchPricingPages[pageName];

type PricingVideoApiProps = Awaited<ReturnType<typeof getData>> & {
  preview: boolean;
};
...
export const getStaticProps = defaultGetStaticProps<PricingVideoApiProps>({
