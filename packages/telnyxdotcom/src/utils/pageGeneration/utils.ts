...
export const formatPageNameWithParams = (page: string, params: ContextProps): string =>
 ...
 */
export const convertUndefinedToNull = (obj: object): { [key: string]: any } | null => {
  ...
  if (type === 'object') {
    if (Array.isArray(obj)) {
      ...
      return Object.fromEntries(Object.entries(obj).map(([k, v]) => [k, convertUndefinedToNull(v)]));
    }
  }
  return obj;
};
