...
How does Telnyx use cookies?
----------------------------

At Telnyx, we want to be transparent about the user information we collect and how we use it. We use cookies across the telnyx.com domain, to support the functionality of our portal, to understand how our customers use our service and to track how the public is engaging with our public content.
...
All personal information is maintained internally, and no information is shared with outside parties for commercial purposes unrelated to Telnyx's business without your express permission. For more information, visit our [Privacy Policy](https://telnyx.com/privacy-policy).
...
Essential cookies (First Party Cookies) are sometimes called “strictly necessary,” as without them, we cannot provide many services that you need on telnyx.com. For example, essential cookies help remember your preferences as you move around the website.

*   Analytics Cookies

These cookies track information about visits to telnyx.com so that we can make improvements and report our performance. For example: analyze visitor and user behavior so as to provide more relevant content or suggest certain activities. They collect information about how visitors use telnyx.com, which site the user came from, the number of each user’s visits and how long a user stays on the site. We might also use analytics cookies to test new ads, pages or features to see how users react to them.

*   Functionality or Preference Cookies

During your visit to telnyx.com, cookies are used to remember information you have entered or choices you make (such as your username, language or your region) on the site. They also store your preferences when personalizing the site to optimize your use of Telnyx, for example, your preferred language. These preferences are remembered, through the use of persistent cookies, and the next time you visit the site, you will not have to set them again.

*   Targeting or Advertising Cookies

These Third Party Cookies are placed by third party advertising platforms or networks in order to deliver ads and track ad performance, enable advertising networks to deliver ads that may be relevant to you based upon your activities (this is sometimes called “behavioral,” “tracking” or “targeted” advertising) on the site. They may subsequently use information about your visit to target you with advertising that you may be interested in, on telnyx.com or other websites. For example, these cookies remember which browsers have visited the site.
