...
import ComposableArticleHero, {
  type ComposableArticleHeroProps,
} from './ComposableArticleHero';

const componentMeta: Meta<ComposableArticleHeroProps> = {
  title: 'Layout/Composable Article Hero',
  component: ComposableArticleHero,
  parameters: {
    layout: 'fullscreen',
  },
};
...
type Story = StoryObj<ComposableArticleHeroProps>;
