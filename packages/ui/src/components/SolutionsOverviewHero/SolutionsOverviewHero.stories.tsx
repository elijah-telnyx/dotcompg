...
import SolutionsOverviewHero, {
  type SolutionsOverviewHeroProps,
} from './SolutionsOverviewHero';
...
const componentMeta: Meta<SolutionsOverviewHeroProps> = {
  title: 'Layout/Hero/Solutions Overview Hero',
  component: SolutionsOverviewHero,
  args: {
...
type story = StoryObj<SolutionsOverviewHeroProps>;
...
export const WithContent: story = {
  args: {
    ...
    mediaList: mock.mediaList as SolutionsOverviewHeroProps['mediaList'],
  },
};
