...
import CategoryHeaderCard, {
  type CategoryHeaderCardProps,
} from './CategoryHeaderCard';

const componentMeta: Meta<CategoryHeaderCardProps> = {
  title: 'Components/CategoryHeaderCard',
  component: CategoryHeaderCard,
};

export default componentMeta;

type Story = StoryObj<CategoryHeaderCardProps>;
